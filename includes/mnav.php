        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    <a href="../../pages/dashboard_member.html" class="nav-item nav-link ">Home</a>
                    <a href="../../pages/mabout.html" class="nav-item nav-link">About</a>
                    <a href="../../modules/motivation_programs/mprogram.php" class="nav-item nav-link" >Program</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="../../modules/blog/mblog.php" class="dropdown-item">Awareness Hub</a>
